            ...
            <v-form ref="form" lazy-validation>
              <v-row dense class="px-4 py-0">
                <v-col cols="12" sm="6" md="6">
                  <v-checkbox
                    label="Enviar para Menbros Equipe"
                    value="membro"
        ...
        <v-card>
          <template>
            ...
            <v-card-text>
              ...
              <v-data-table :headers="headers" :items="notificacoes" :search="search">
                <!-- relacionamento criado para ir buscar o responsavel que criou a notificação -->
...
export default {
  props: ["notificacoes", "funcoes", "responsaveis", "projectos","projectos_responsavel"],
  components: {
    AppLayout,
  },
  ...
  data() {
    return {
      ...
      headers: [
        // { text: "Nº", value: "id", class: "font-weight-blod  py-7 " },
        {
          value: "responsavel",
          sortable: false,
        ...
        {  text: "Data de envio",
          value: "created_at", sortable: false, class: "font-weight-blod " },
          {
          text: "visualizar",
          value: "actions",
        // sortable: false,
  ...
  methods: {
    ...
    verDetalhe(item) {
      ...
      // alert(JSON.stringify(this.notificacao))
    ...
    save() {
      if (this.$refs["form"].validate()) {
        this.$inertia.post("/notificacoes/salvar-notificacao", this.notificacao, {
          onFinish: () => {
