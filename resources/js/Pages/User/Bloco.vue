    ...
    <app-layout>
        ...
        <v-card class="my-5 elevation-0">
            ...
            <v-card-title>
              ...
              >
                        ...
                        <v-autocomplete prepend-icon="" @change="filtrarEstado()" v-model="query.bloco_id"
                            :items="blocos" item-value="id" item-text="descricao_bloco" type="text" outlined
                            clearable dense>
                        </v-autocomplete>
                    </v-col>
                    <v-col cols="6" sm="6" md="3">
                    ...
                    <v-col cols="6" sm="6" md="3">
                        ...
                        <v-autocomplete @change="filtrarEstado()" clearable v-model="query.estado_bloco_id"
                            :items="tipologias" item-text="descricao" item-value="id" prepend-icon=""
                    ...
                    <v-col cols="6" sm="6" md="3" class="text-right">
                        ...
                        <v-text-field @input="filtrarData()" label="Data de Criação" v-model="query.data_inicial"
                            type="date" :rules="dataInicialfiltroRules" :error-messages="erros.dat_inicio_real" outlined
                            dense>
                        </v-text-field>
        ...
        <v-card class="elevation-0">
            <v-card-text>
                ...
                <v-data-iterator :items="blocos" :items-per-page.sync="itemsPerPage" :page.sync="page" :search="search"
                    hide-default-footer>
                    <template v-slot:default="props">
                        <v-row align="center" justify="center" dense>
                            <v-col v-for="item in props.items" :key="item.nome_proj" @click="tarefasProjecto(item.id)"
                                cols="12" sm="12" md="6" :lg="blocos.length <= 3 ? 6 : 4">
